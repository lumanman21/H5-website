...
if(xintheme('cat_type_single')){
	...
	if( $category_layout == 'grid' ){
		include( 'single/single-grid.php' );
	}elseif($post_layout == 'news'){
		get_template_part( 'single/single-news' );
	}elseif($post_layout == 'solution'){
		get_template_part( 'single/single-solution' );
	}elseif($post_layout == 'project'){
		get_template_part( 'single/single-project' );
	}
	else{
		get_template_part( 'single/single-news' );
	}
