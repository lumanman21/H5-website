...
$query->set('cat','4'); //分类的ID，前面加负号表示排除；如果直接写ID，则表示只在该ID中搜索
}
return $query;
}
...
h1 a {background-image: url('.get_bloginfo('template_directory').'/static/images/admin/wordpress-logo.svg) !important; }
</style>';
}
...
function change_post_menu_name() {
    global $menu;
    global $submenu;
    $menu[5][0] = '产品\新闻';	// 把“文章”名称改为“产品中心”
    $submenu['edit.php'][5][0] 	= '产品\新闻'; // 把“所有文章”名称改为“产品列表”
    $submenu['edit.php'][10][0] = '添加产品\新闻'; // 把“添加文章”名称改为“添加产品”
    $submenu['edit.php'][15][0] = '产品\新闻分类'; // 把“分类目录”名称改为“产品分类”
}
...
function change_post_object_label() {
    ...
    $labels->name = '产品\新闻';
    $labels->singular_name = '产品\新闻';
    $labels->add_new = '添加产品\新闻';
    $labels->add_new_item = '创建';
    $labels->edit_item = '编辑产品\新闻';
    $labels->new_item = '产品';
    $labels->view_item = '查看产品\新闻';
    $labels->search_items = '搜索产品\新闻';
    $labels->not_found = '产品\新闻显示为空';
    $labels->not_found_in_trash = '产品\新闻回收站显示为空';
}
