  ...
  array(
		...
		'fields'   => array(
			...
			array(
			  ...
			  'type'            => 'group',
			  'title'           => '英文banner',
			  'button_title'    => '英文banner',
			  'accordion_title' => '英文banner',
			  'fields'          => array(
          array(
            'id'          => 'banner_ba_img',
            'type'        => 'upload',
        ...
        array(
          ...
          'type'            => 'group',
          'title'           => '中文banner',
          'button_title'    => '中文banner',
          'accordion_title' => '中文banner',
          'fields'          => array(
            array(
              'id'          => 'banner_ch_img',
              'type'        => 'upload',
