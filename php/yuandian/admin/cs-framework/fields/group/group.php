...
class CSFramework_Option_group extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<div class="cs-group cs-group-'. $el_class .'-adding hidden">';
      ...
      echo '<div class="cs-element cs-text-right cs-remove"><a href="#" class="button cs-warning-primary cs-remove-group">'. esc_html__( '删除', 'cs-framework' ) .'</a></div>';
      echo '</div>';
    ...
    echo '<div class="cs-groups cs-accordion">';
      ...
      if( ! empty( $this->value ) ) {
        ...
        foreach ( $this->value as $key => $value ) {
          ...
          // 修改删除
          // if ($this->field['id'] == 'banner_o' || $this->field['id'] == 'banner_v'){
          //   echo '<div class="cs-element cs-text-right cs-remove" style="display:none"><a href="#" class="button cs-warning-primary cs-remove-group">'. esc_html__( '删除', 'cs-framework' ) .'</a></div>';
          // } else {
          //   echo '<div class="cs-element cs-text-right cs-remove" ><a href="#" class="button cs-warning-primary cs-remove-group">'. esc_html__( '删除', 'cs-framework' ) .'</a></div>';
          // }
    ...
    // if ($this->field['id'] == 'banner_o' || $this->field['id'] == 'banner_v'){
    //   echo '<a href="#" class="button button-primary cs-add-group" style="display:none">'. $this->field['button_title'] .'</a>';
    // } else {
