...
<footer class="bor">
	...
	<div class="f_box wrap pt60 pb50">
		<div class="f_form">
			<h6 class="f_tit">contact us</h6>
			<p>
				Welcome to leave us a message and obtain product quotes.We will reply to you within 24 hours.
			</p>
		...
		<ul class="f_nav">
			...
			<li>
				...
				<dl>
					...
					?>
					<li><a href="<?php echo esc_url( get_category_link( $cat->term_id ) ); ?>" title="<?php echo esc_attr( $cat->name ); ?>"><?php echo esc_html( $cat->name ); ?> </a></li>
					<?php } ?>
		...
		<dl class="f_media">
			<dt><a href="<?php echo xintheme('consultation_facebook_url'); ?>"><img src="<?php bloginfo('template_url'); ?>/static/images/media/facebook_color.svg" alt=""></a></dt>
			<dt><a href="<?php echo xintheme('consultation_facebook_url'); ?>"><img src="<?php bloginfo('template_url'); ?>/static/images/media/instagram-fill.svg" alt=""></a></dt>
			<dt><a href="<?php echo xintheme('consultation_instagram_url'); ?>"><img src="<?php bloginfo('template_url'); ?>/static/images/media/twitter_color.svg" alt=""></a></dt>
			<dt><a href="<?php echo xintheme('consultation_youtube_url'); ?>"><img src="<?php bloginfo('template_url'); ?>/static/images/media/Youtube_color.svg" alt=""></a></dt>
		</dl>
	</div>
	<div class="f_copy wrap">
		<a href="javascript:;">© 2023 All Rights reserved Anhui Inno-Sign International Trade Co., Ltd. Design by
			Anhuilingju</a>
...
<script>
	jQuery(document).ready(function() {
		...
		jQuery('#wpforms-73-field_5').val(current_url);
		jQuery('#wpforms-77-field_5').val(current_url);
		jQuery('#wpforms-101-field_5').val(current_url);
	});
</script>
<!-- 表单获取询盘来源（AD or SEO） -->
<script>
	...
	if (username === 'ad') {
		...
		$('#wpforms-73-field_6').val("来自于广告的询盘");
		$('#wpforms-77-field_6').val("来自于广告的询盘");
		$('#wpforms-101-field_6').val("来自于广告的询盘");
	} else {
		$('#wpforms-63-field_5').val("来自于SEO的询盘");
		$('#wpforms-67-field_5').val("来自于SEO的询盘");
		$('#wpforms-73-field_6').val("来自于SEO的询盘");
		$('#wpforms-77-field_6').val("来自于广告的询盘");
		$('#wpforms-101-field_6').val("来自于广告的询盘");
	}
