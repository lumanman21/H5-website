...
<div class="mao_box wrap bc_black">
	<div class="in_nav">
	  ...
	  <ul class="menu_list">
		...
		<li class="list active"><a href="<?php echo get_permalink(14); ?>">patent</a></li>
	  </ul>
	</div>
</div>
...
<section class="m80">
	<div class="wrap">
		...
		<ul class="certy_list mt50">
			<?php
				if( xintheme('in_patent') ){
				$in_patent = explode(',', xintheme('in_patent'));
				foreach ( $in_patent as $id ) :
