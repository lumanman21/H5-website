...
if(audioE2){
	...
	audioE2 .onloadedmetadata = function() {
		...
		var banner_swiper = new Swiper('.i_banner .swiper-container',{
			...
			on: {
				init: function(){
					$('.i_banner .swiper-slide').eq(this.activeIndex).find('.text').addClass('active');
				...
				slideChangeTransitionStart: function(){
					$('.i_banner .swiper-slide').find('.text').removeClass('active').eq(this.activeIndex).addClass('active').siblings();
					var _target = this;
